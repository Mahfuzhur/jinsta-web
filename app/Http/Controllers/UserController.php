...
//                    GROUP BY a.id");
    ...
    public function SetSchedule(Request $request){
        ...
        if(Auth::user()){
            ...
            $specify_time_start = $this->time_subtract($request->specify_time_start);
            $specify_time_end = $this->time_subtract($request->specify_time_end);
            $time_exclusion_setting_start = $this->time_subtract($request->time_exclusion_setting_start);
            $time_exclusion_setting_end = $this->time_subtract($request->time_exclusion_setting_end);
